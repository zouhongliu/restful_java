...
public class Food {
	...
	public Response getFoodById(@PathParam("id") String id) {
		...
		.entity("[{"+"\"id\":\"" + id + "\",\"name\":\"name1\",\"company\":\"company1\",\"foodNutritionTable\":\"nutritionTable1\"}]").build();
	...
	public Response getFoodByName(@PathParam("name") String name) {
		return Response.status(200)
			.entity("[{\"id\":\"id1\",\"name\":\"" + name +"\",\"company\":\"company1\",\"foodNutritionTable\":\"nutritionTable1\"}]").build();
	}
	...
	public Response setfood(
		...
		return Response.status(200)
			.entity("[{\"name\":\"" + name +"\",\"company\":\"" + company + "\",\"foodNutritionTable\":\"" + nutritionTable + "\"}]").build();
	}
